		...
		function widget($args,$instance)
		{
			...
			<?php } else if($Rich_Web_Slider_Effects[0]->slider_type=='Content Slider'){ ?>
				...
				<div class="main main_<?php echo $Rich_Web_Slider_Manager[0]->id;?>" style="display:none;" >
					<div class="page_container">
						<div id="immersive_slider_<?php echo $Rich_Web_Slider_Manager[0]->id;?>" style='background:<?php echo $Rich_Web_Slider_Effect[0]->rich_CS_Cont_BgC;?>;box-shadow:0px 0px 30px <?php echo $Rich_Web_Slider_Effect[0]->rich_CS_Cont_BSC;?>;opacity:1;border-top:<?php echo $Rich_Web_Slider_Effect[0]->rich_CS_Cont_BW;?>px <?php echo $Rich_Web_Slider_Effect[0]->rich_CS_Cont_BS;?> <?php echo $Rich_Web_Slider_Effect[0]->rich_CS_Cont_BC;?>;border-bottom:<?php echo $Rich_Web_Slider_Effect[0]->rich_CS_Cont_BW;?>px <?php echo $Rich_Web_Slider_Effect[0]->rich_CS_Cont_BS;?> <?php echo $Rich_Web_Slider_Effect[0]->rich_CS_Cont_BC;?>;border-radius:<?php echo $Rich_Web_Slider_Effect[0]->rich_CS_Cont_BR;?>px;'>
							<?php for($i=0;$i<count($Rich_Web_Slider_Images);$i++){ 
								if(strpos($Rich_Web_Slider_Images[$i]->Sl_Img_Url, 'youtube') > 0)
								{
									$rest_vImg_url = substr($Rich_Web_Slider_Images[$i]->Sl_Img_Url, 0, -13);
			...
			<?php } else if($Rich_Web_Slider_Effects[0]->slider_type=='Accordion Slider'){ ?>
				...
				<section class="main" id="rw_acc_main<?php echo $Rich_Web_Slider_Manager[0]->id;?>" style="display: none;">
					<div class="ia-container_<?php echo $Rich_Web_Slider_Manager[0]->id;?>" style='border:<?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AcSL_BW;?>px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AcSL_BS;?> <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AcSL_BC;?>;'>
					<?php for($i=0;$i<count($Rich_Web_Slider_Images);$i++){ 
						if(strpos($Rich_Web_Slider_Images[$i]->Sl_Img_Url, 'youtube') > 0)
						{
							$rest_vImg_url = substr($Rich_Web_Slider_Images[$i]->Sl_Img_Url, 0, -13);
